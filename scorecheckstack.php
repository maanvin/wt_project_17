<?php
  ...
  if($score>3)
    ...
    $badge1=0;
  $q1 = "insert into user_details (st_sc,badge1) values ('$score','$badge1') where username='$t'";
...
<html>
	<head>
		...
		<style type="text/css">
			...
			button{height: 50px; background-color: #21aec6; font-size:15px; border-color: black}
		</style>
	</head>
    ...
    <div class="drop" id="signin" style="position: absolute; width: 220px;height: 200px; top: -150px; right: 1%">
      ...
      <div style="position: absolute; bottom: 0px; left: 20px; width: 150px;" id="floatlist">
		...
		<a href="stack.php"><button style="position: absolute; top: 600px;left:700px">Back to Stacks</button></a>
