<?php
  ...
  if($score>3)
    ...
    $badge2=0;
  $q1 = "insert into user_details (q_sc,badge2) values ('$score','$badge2') where username='$t'";
...
<html>
    ...
    <div class="drop" id="signin" style="position: absolute; width: 220px;height: 200px; top: -150px; right: 1%">
      ...
      <div style="position: absolute; bottom: 0px; left: 20px; width: 150px;" id="floatlist">
        <div class="floater" style="position: absolute; bottom: 0px; opacity: 0; z-index: -1;" id="l1"><i class="material-icons">fiber_manual_record</i> <a href="code_queue">Code</a></div>
